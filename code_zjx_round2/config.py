...
testPath = r'..\data\DatasetA\test\lumbar_testA50'
testjsonPath = r'..\data\DatasetA\test\test_new.json'
...
checkpoints_dir = r".\checkpoint\%s_Weights"%(model_name)
...
test_batch_size = 16
submision_output_file_path = r"../submit/testB_%s_weighted_3.json"%model_name
models_dir = r".\checkpoint\%s_Weights"%model_name