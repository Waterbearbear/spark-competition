...
# def disPointToLine(x1,x2,point):
#     #x1,x2 为轴状图和失位面的交线两端点
#     #point为
#
#
#     line_vector = x2 - x1
...
#
#
#     distant = np.sqrt(np.square(point - xc).sum())
#
#
#
#     return distant
    ...
    for study in result:
        ...
        for point in points:
            ...
            if 'disc' in point['tag'].keys():
                ...
                # print("Disc_landmark :",Disc_landmark)
                #
                # print("spacing: ",spacing)
                #
                # print("direct_vector: ",direct_vector)
                ...
                # break
                axial_result_csv.disc_dcmPath[axial_result_csv['dcmPath'] == axial_path]   = study['dcmPath']
                axial_result_csv.identification[axial_result_csv['dcmPath'] == axial_path] = point['tag']['identification']
                axial_result_csv.label[axial_result_csv['dcmPath'] == axial_path]          = point['tag']['disc']
        ...
        # value = axial_result_csv.loc[0,'disc_dcmPath']
        # print(value)
        #
        # mask = (axial_result_csv['disc_dcmPath'] == '')
        # axial_result_csv[mask]
        # print(mask)
...
if __name__ == '__main__':
    ...
    # axial_result = np.load('axial_info.npy',allow_pickle= True)
    #
    # # print(axial_result)
    # # result = pd.read_csv('result.csv')
    # # axial_result_csv = pd.read_csv('dcm_info.csv')
    #
    # # axial_result_csv = pd.read_csv('axial_info.csv')
    #
    # # axial_result_dict = axial_result_csv.iloc[:, 1:].to_dict(orient = 'records')
    #
    # print(axial_result[0])


    # print(axial_result_dict)
    # np.save('axial_info.npy',axial_result_dict)



    # result.drop(labels = [],axis = 1)

    # print(result)

    # result_dict = result.iloc[:,1:].to_dict(orient = 'records')
    # axial_result_dict = axial_result.iloc[:,1:].to_dict(orient = 'records')
    #
    # np.save('result.npy', result_dict)
    # np.save('dcm_info.npy',axial_result_dict)


    #
    # print(axial_result['studyUid'])
    ...
    #     # print(study_all_axial)
    #
    #     annotation = eval(study['annotation'])
    #
    #     # print(annotation[0])
    #     # print(annotation[0]['data'])
    #     #
    ...
    #
    #                 # print("",i)
    #                 # print("index: %d,dicomPath: %s "%(i,axial['dcmPath']),end = '')
    #
    #                 ImagePosition = np.array(axial['ImagePosition'].split('\\'), np.float)
    #
    #
    ...
    # temp = dframe['annotation'][0]
    # print(type(temp))
    # print(type(temp))

    # print(dframe['annotation'][0])
    # print(dframe['annotation'][0][0])
